...
class Controle:
    ...
    def printMemóriaBin(self):
        ...
        self.view.printMemória("Operando em binário:"+str(lista1))
        self.view.printMemória("Operando em binário:"+str(lista2))
    ...
    def operaçãoEscolhida(self):
        if(self.memória.operação_escolhida == "+"):
           ...
           self.view.printMemória("Resultado soma:"+str(resultado))
            ...
            self.view.printMemória("Resultado Subtração:"+str(resultado))
        elif(self.memória.operação_escolhida == "*"):
